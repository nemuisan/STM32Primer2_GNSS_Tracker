...
#define MMC_GET_SDSTAT		54	/* Read SD_STATUS */
#define MMC_GET_EXTCSD		55	/* Read EXT_CSD */
#define ISDIO_READ			56	/* Read data form SD iSDIO register */
#define ISDIO_WRITE			57	/* Write data to SD iSDIO register */
#define ISDIO_MRITE			58	/* Masked write data to SD iSDIO register */
...
#define CT_BLOCK	0x10		/* Block addressing mode */
#define CT_WIDE		0x20		/* Wide bus mode */
