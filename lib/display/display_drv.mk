...
else ifeq ($(USE_DISPLAY),USE_SSD1351_SPI_OLED)
USE_TOUCH_CTRL = NO_TOUCH_CTRL
CFILES += \
 $(DISPLAY_DRV_SRC)/ssd1351.c
...
else ifeq ($(USE_DISPLAY),USE_ILI9342_SPI_TFT)
CFILES += \
 $(DISPLAY_DRV_SRC)/ili9342.c
...
else ifeq ($(USE_DISPLAY),USE_RM68110_TFT)
USE_TOUCH_CTRL = NO_TOUCH_CTRL
CFILES += \
 $(DISPLAY_DRV_SRC)/rm68110.c
...
else ifeq ($(USE_DISPLAY),USE_ILI9806H_TFT)
USE_TOUCH_CTRL = NO_TOUCH_CTRL
CFILES += \
 $(DISPLAY_DRV_SRC)/ili9806h.c

else ifeq ($(USE_DISPLAY),USE_RM68120_TFT)
CFILES += \
 $(DISPLAY_DRV_SRC)/rm68120.c

else ifeq ($(USE_DISPLAY),USE_OTM8009A_DSI_TFT)
CFILES += \
 $(DISPLAY_DRV_SRC)/otm8009a_dsi.c

else ifeq ($(USE_DISPLAY),USE_ILI9806G_TFT)
SYNTHESIS_DEFS	+= -DTOUCH_REV_XY
CFILES += \
 $(DISPLAY_DRV_SRC)/ili9806g.c

else ifeq ($(USE_DISPLAY),USE_R61408_TFT)
SYNTHESIS_DEFS	+= -DTOUCH_REV_XY
CFILES += \
 $(DISPLAY_DRV_SRC)/r61408.c

else ifeq ($(USE_DISPLAY),USE_ST7789V2_SPI_TFT)
USE_TOUCH_CTRL = NO_TOUCH_CTRL
CFILES += \
 $(DISPLAY_DRV_SRC)/st7789v2.c

else ifeq ($(USE_DISPLAY),USE_NT35516_TFT)
USE_TOUCH_CTRL = NO_TOUCH_CTRL
CFILES += \
 $(DISPLAY_DRV_SRC)/nt35516.c

else ifeq ($(USE_DISPLAY),USE_HX8363B_TFT)
USE_TOUCH_CTRL = NO_TOUCH_CTRL
CFILES += \
 $(DISPLAY_DRV_SRC)/hx8363b.c

else ifeq ($(USE_DISPLAY),USE_RM68180_TFT)
USE_TOUCH_CTRL = NO_TOUCH_CTRL
CFILES += \
 $(DISPLAY_DRV_SRC)/rm68120.c
 
else ifeq ($(USE_DISPLAY),USE_ST7796_SPI_TFT)
USE_TOUCH_CTRL = NO_TOUCH_CTRL
CFILES += \
 $(DISPLAY_DRV_SRC)/st7796.c
